...
export const CLUB_SKILLS: Record<string, ClubSkill> = {
  "soengsang-united": {
    ...
    tactics: "4-3-3 / 4-2-3-1 — เน้นครองบอลแล้วเจาะทางริมเส้น",
    accentColor: "#1a5276",
  },
  "nondaeng-fc": {
    style: "สวนกลับเร็ว",
  ...
  "pakthongchai-united": {
    style: "เพรสซิ่งสูง",
    strengths: [
      "เพรสซิ่งสูงแย่งบอลเร็ว",
      "พลังงานสูงวิ่งไม่มีหมด",
      "เกมรุกกดดันต่อเนื่อง",
      "ทีมเวิร์คดีเล่นเป็นกลุ่ม",
    ],
    tactics: "4-3-3 — เพรสซิ่งสูงแล้วจบสกอร์เร็ว",
    accentColor: "#27ae60",
  },
  "khonburi-fc": {
    style: "ดุดัน & ไดเรกต์",
    strengths: [
      "ร่างกายแข็งแกร่งดวลบอลอากาศ",
      "ไดเรกต์เล่นบอลยาว",
      "เกมรับแข็งแกร่ง",
      "จิตใจนักสู้ไม่ยอมแพ้",
    ],
    tactics: "4-4-2 — เน้นความแข็งแกร่งและไดเรกต์",
    accentColor: "#f39c12",
  },
  "suranaree-fc": {
    style: "เทคนิค & สร้างสรรค์",
    strengths: ["นักเตะเทคนิคสูง", "สร้างสรรค์โอกาสเก่ง", "เล่นบอลภาคพื้นดี", "พลิกแพลงเก่ง"],
    tactics: "4-2-3-1 — เน้นเทคนิคและความคิดสร้างสรรค์",
    accentColor: "#8e44ad",
  },
  "union-korat": {
    style: "สมดุล & มีระเบียบ",
