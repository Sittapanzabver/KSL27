...
| [03-data-model-for-skills](tickets/03-data-model-for-skills.md) | Research | 🟢 Frontier | ~~01~~ (resolved) |
...
- 03-data-model-for-skills (research — optional, data is hardcoded)

## Not yet specified

- Wayfinder search results UI (autocomplete dropdown vs full page)
- Mobile vs desktop wayfinder behavior
